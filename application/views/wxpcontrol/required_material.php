...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            <?php $this->load->view('wxpcontrol/common/header') ?>
            <?php $this->load->view('wxpcontrol/common/slider') ?>
            <div class="content-wrapper">
                <section class="content-header" >

                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> Dashboard</a></li>
                        <li class="active">Required Material</li>
                    </ol>
                </section>
            ...
            <?php $this->load->view('wxpcontrol/common/footer') ?>
