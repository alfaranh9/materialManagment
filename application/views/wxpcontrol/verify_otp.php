<?php
$enter_valid_email = 'Please Enter OTP';
?>
...
<div class="login-box">
	...
	<div class="login-box-body">
		...
		<form action="<?php echo base_url(); ?>admin/verifyOTP" id="otp-form" method="post">
			<div class="form-group has-feedback">
				<input type="text" name="otp" id="otp" class="form-control" placeholder="Enter OTP">
				<div class="error_msg1"><?php echo form_error('otp'); ?></div>
...
<script>
	...
	$(function () {
		$("#otp-form").validate({
			...
			messages: {
				otp: "<b id='juqey_7815'><?php echo $enter_valid_email?></b>"
